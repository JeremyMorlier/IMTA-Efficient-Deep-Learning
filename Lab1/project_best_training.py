...
from tools.training import train, save
...
# Exemple :
experiment_Name = "DenseNet_Adam"
description = "DensetNet 121 with Cross Entropy Loss, ADAM (lr=0.01), lr_scheduler.MultiStepLR(optimizer, milestones=[100, 200], gamma=0.1)"
model = DenseNet121()

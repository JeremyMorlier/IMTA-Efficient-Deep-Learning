...
# Expérience 1
experiment_Name = "Scheduler1"
description = "Groups convolution on densenet_cifar net trained on CIFAR10, SGD (lr=0.1), lr_scheduler.MultiStepLR(optimizer, milestones=[100, 200], gamma=0.1)"
...
save(experiment_Name, description, resultsPath, results, model, densenet_cifar_groups())

# Expérience 2
experiment_Name = "Scheduler2"
description = "Groups convolution on densenet_cifar net trained on CIFAR10,  SGD (lr=0.1), lr_scheduler.MultiStepLR(optimizer, milestones=[50, 100,150], gamma=0.1)"
...
# Expérience 3
experiment_Name = "Scheduler3"
description = "Groups convolution on densenet_cifar net trained on CIFAR10,  SGD (lr=0.1), lr_scheduler.MultiStepLR(optimizer, milestones=[50, 100,150], gamma=0.2)"
